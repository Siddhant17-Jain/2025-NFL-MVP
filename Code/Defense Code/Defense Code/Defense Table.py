...
data_dir = '/Users/siddhantjain/PycharmProjects/NFL MVP/Defense Files/Separate CSV'

# List of teams we are interested in
teams = ['Cincinnati Bengals', 'Buffalo Bills', 'Detroit Lions', 'Baltimore Ravens', 'Minnesota Vikings']

# List of the statistics files (this should match the files in your directory)
metrics = [
    "EPA-Play", "Success %", "EPA-Pass", "EPA-Rush", "Sack %", "INT %",
    "PA", "Tot Yds", "Tot 1stD", "TO%", "EXP"
]
