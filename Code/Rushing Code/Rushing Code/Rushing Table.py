...
data_dir = '/Users/siddhantjain/PycharmProjects/NFL MVP/Rushing Files/Separate CSV'

# List of teams we are interested in
teams = ['CIN', 'BUF', 'DET', 'BAL', 'MIN']
...
metric_full_names = {
    ...
    "Yards per Carry": "Yards per Carry",
    "TD %": "Touchdown Percentage",
    "First Down %": "First Down Percentage",
    "Yards after Contact": "Yards after Contact",
    "Tackle for Loss %": "Tackle for Loss Percentage",
    "Explosive %": "Explosive Percentage",
}
